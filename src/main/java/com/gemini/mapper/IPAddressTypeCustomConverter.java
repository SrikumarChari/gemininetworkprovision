 ...
 * @author schari
 */
public class IPAddressTypeCustomConverter implements CustomConverter {
    ...
    public Object convert(Object destValue, Object sourceValue, 
        ...
        if (sourceValue instanceof String) {
            ...
            Logger.error ("IP Address Type converter used incorrectly - invalid address type {}", (String)sourceValue);
