 ...
 * @author schari
 */
public class ProtocolCustomConverter implements CustomConverter{
    ...
    public Object convert(Object destValue, Object sourceValue, Class<?> destinationClass, Class<?> sourceClass) {
        ...
        if (sourceValue instanceof String) {
            ...
            Logger.error("Protocol Custom Converter used incorrectly. Arguments passed in were: source\n {} \n destination\n {}",
