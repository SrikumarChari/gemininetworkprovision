...
public class SecurityProviderOpenStackTest {
    ...
    public static void setUpClass() {
        ...
        //setup the tenant
        tenant.setName("facebook532739873");
        tenant.setDomainName("");
        tenant.setTenantID("04dd264b60d541f8823f1a1f999eadaa");

        //setup the environment
        env.setName("Test Project");
        env.setType(GeminiEnvironmentType.OPENSTACK);
        env.setAdminUserName("facebook532739873");
        env.setAdminPassword("Oga1qv08l8NNpvQq");
        env.setEndPoint("http://8.21.28.222:5000/v2.0");
